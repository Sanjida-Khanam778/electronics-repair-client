    ...
    <div className="w-full md:w-11/12 mx-auto mb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div
          ...
          data-aos="fade-up"
        >
          <img className="h-56 rounded-2xl border-2 mb-4" src={img1} alt="Expert Technicians" />
          <FaTools size={50} className="text-blue-600 mb-4" />
          <h2 className="font-bold text-3xl mb-2">Expert Technicians</h2>
          <p className="text-gray-600 flex-grow">Certified and experienced professionals</p>
        ...
        <div
          ...
          data-aos-delay="200"
        >
          <img className="h-56 rounded-2xl border-2 mb-4" src={img1} alt="Quick Turnaround" />
          <FaClock size={50} className="text-green-500 mb-4" />
          <h2 className="font-bold text-3xl mb-2">Quick Turnaround</h2>
          <p className="text-gray-600 flex-grow">Same-day service for most repairs</p>
          <button className="px-4 py-2 btn mt-2 bg-red-600 text-white rounded-full hover:bg-red-500">
            Learn More About Us
          </button>
        </div>
        <div
          ...
          data-aos-delay="400"
        >
          <img className="h-56 rounded-2xl border-2 mb-4" src={img1} alt="Transparent Pricing" />
          <FaDollarSign size={50} className="text-blue-600 mb-4" />
          <h2 className="font-bold text-3xl mb-2">Transparent Pricing</h2>
          <p className="text-gray-600 flex-grow">No hidden costs, upfront quotes</p>
          <button className="px-4 py-2 btn mt-2 bg-red-600 text-white rounded-full hover:bg-red-500">
            Learn More About Us
          </button>
        </div>
        <div
          ...
          data-aos-delay="600"
        >
          <img className="h-56 rounded-2xl border-2 mb-4" src={img1} alt="Warranty Coverage" />
          <FaShieldAlt size={50} className="text-green-600 mb-4" />
          <h2 className="font-bold text-3xl mb-2">Warranty Coverage</h2>
          <p className="text-gray-600">All repairs backed by a satisfaction guarantee</p>
          <button className="px-4 py-2 btn mt-2 bg-red-600 text-white rounded-full hover:bg-red-500">
            Learn More About Us
          </button>
        </div>
